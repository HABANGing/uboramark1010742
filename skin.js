...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		hs='data:image/svg+xml;base64,';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
		...
		me.__12.logicBlock_position = function() {
			var newLogicStatePosition;
			if (
				((player.getViewerSize(true).width <= 460))
			)
			{
				newLogicStatePosition = 0;
			}
		...
		me._scrollarea_1.logicBlock_size = function() {
			var newLogicStateSize;
			if (
				((player.getViewerSize(true).width <= 670))
			)
			{
				newLogicStateSize = 0;
			}
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,';
	...
	function SkinHotspotClass__0(parentScope,hotspot) {
		...
		me.__0.onmouseenter=function (e) {
			player.setActiveHotspot(me.hotspot);
			me.elementMouseOver['_0']=true;
			player.triggerEvent('hsproxyover', {'id': me.hotspot.id, 'url': me.hotspot.url});
		}
		me.__0.onmouseleave=function (e) {
			player.setActiveHotspot(null);
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		me._image_3.logicBlock_position = function() {
			...
			if (me._image_3.ggCurrentLogicStatePosition != newLogicStatePosition) {
				...
				me._image_3.style.transition='left 800ms linear 0ms, top 800ms linear 0ms';
		...
		me._text_6.logicBlock_size = function() {
			...
			if (me._text_6.ggCurrentLogicStateSize != newLogicStateSize) {
				...
				me._text_6.style.transition='width 0s, height 0s';
		...
		els.className='ggskin ggskin_nodeimage';
		if (nodeId) els.setAttribute('src',basePath + "images/_6_" + nodeId + ".png");
		el.ggNodeId=nodeId;
		hs ='';
		hs += 'position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;;';
		hs+='border-radius: 50px;';
